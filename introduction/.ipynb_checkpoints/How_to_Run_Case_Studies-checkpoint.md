...
```{note}
In our [github repository](https://github.com/UCC-CLIMPADAP/SVIBook) you can find the case studies in the [Cities/ folder](https://github.com/UCC-CLIMPADAP/SVIBook/tree/gh-pages/Cities) where you can find the descriptions of the cities and 3 Jupyter Notebooks for each city.   
```
